$(document).ready(function () {
  ...
  //Array of sitcom characters
  var topics = ["Ted Mosby", "Chandler Bing", "Leslie Knope", "Jess Day", "John Dorian"];
  var resultNum = 10;
  ...
  function displayGif() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + searchChar + "&api_key=NOZNqdo0bhtICbQksv8XutLHsAvMQayO";
